...
# -------------------------
    ...
    if st.button("Valider la formulation"):
        ...
        def interpretation_score(score):
            if score < 10:
                return ("🔴 Score faible — reformulation nécessaire", "red")
            elif 10 <= score < 20:
                return ("🟡 Score bon — formulation stable et cohérente", "orange")
            else:
                return ("🟢 Score excellent — formulation optimale", "green")
